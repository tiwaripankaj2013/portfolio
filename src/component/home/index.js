            ...
            <div className="flex min-h-screen w-full items-center justify-center">
              <div className="herosection-content w-full py-20 text-center md:w-3/4">
                ...
                >
                  ...
                  <div className="herosection-image fiximage relative z-20 inline-block h-[150px] w-[150px] overflow-hidden rounded-full border-8 border-primary border-opacity-10 align-middle">
                    <img src={profile} alt={name} />
                  </div>
                </div>
                <h1
                  className="mb-5 text-heading text-5xl font-bold"
                >
